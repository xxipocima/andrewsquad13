...
const BannerData = [
    {
        ...
        title: "Andrew Squad13",
        description: "Докажу ТЕБЕ, что ТВОИ возможности безграничны."
    },
    // {
                                        ...
                                        <div className="order-2 order-lg-1 col-lg-7">
                                            <div className="inner text-left">
                                                ...
                                                <div className="button-group mt--30">
                                                    <a className="btn-default" target="_blank" href="https://themeforest.net/checkout/from_item/33571911?license=regular">GO</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <SectionTitle
                                    ...
                                    radiusRounded = ""
                                    subtitle = "Trening plans."
                                    title = "Выбери свой вариант тренинга."
